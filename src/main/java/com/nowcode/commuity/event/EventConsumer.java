package com.nowcode.commuity.event;
...
public class EventConsumer implements Constant {
    ...
    public void handleMutilMessage(ConsumerRecord record){
    ...
    public void handlePublishMessage(ConsumerRecord record){
        ...
        DiscussPost discussPost = discussPostService.selectPostDetail(event.getEntityId());
    ...
    public void handleDeleteMessage(ConsumerRecord record){
        ...
        elasticsearchRepository.delete(event.getEntityId());
